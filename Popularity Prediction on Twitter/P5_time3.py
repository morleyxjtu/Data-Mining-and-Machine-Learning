'''
Use previous linear regression model for time period #3 to predict number of tweets
...
gohawk = joblib.load('P4_time3_#gohawks.pkl') 
...
gopatriots = joblib.load('P4_time3_#gopatriots.pkl') 
...
nfl = joblib.load('P4_time3_#nfl.pkl') 
...
patriots = joblib.load('P4_time3_#patriots.pkl') 
...
sb49 = joblib.load('P4_time3_#sb49.pkl') 
...
superbowl = joblib.load('P4_time3_#superbowl.pkl') 

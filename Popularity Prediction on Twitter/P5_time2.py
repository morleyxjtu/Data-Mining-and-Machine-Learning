...
gohawk = joblib.load('P4_time2_#gohawks.pkl') 
...
gopatriots = joblib.load('P4_time2_#gopatriots.pkl') 
...
nfl = joblib.load('P4_time2_#nfl.pkl') 
...
patriots = joblib.load('P4_time2_#patriots.pkl') 
...
sb49 = joblib.load('P4_time2_#sb49.pkl') 
...
superbowl = joblib.load('P4_time2_#superbowl.pkl') 
